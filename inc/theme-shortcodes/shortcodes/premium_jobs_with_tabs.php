								  ...
								  <div class="row">';
									...
									if ( $job_class_query->have_posts() )
									{
										...
										{ 
												...
												{ 
													$apply_button = '<a href="javascript:void(0)" class="external_apply" data-job-id="'. esc_attr( $job_id ).'"  data-job-exter="'.( $job_apply_url ).'">'. esc_html__('Apply now', 'nokri' ).'</a>';
												}
												else if ($job_apply_with == 'mail') 
												{
													$apply_button = '<a href="javascript:void(0)" class="external_apply" data-job-id="'. esc_attr( $job_id ).'" data-job-exter="'.( $job_apply_mail ).'">'. esc_html__('Apply now', 'nokri' ).'</a>';
												}
												else
												{
													$apply_button = '<a href="javascript:void(0)" class="apply_job" data-toggle="modal" data-target="#myModal"  data-job-id='.esc_attr( $job_id ).'>'.esc_html__( 'Apply Now', 'nokri' ).' </a>';
												}
