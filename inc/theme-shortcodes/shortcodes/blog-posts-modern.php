											...
											<div class="nth-latest-content">
												...
												<div class="nth-latest-box">
													...
													<div class="nth-latest-blog">
														...
														'.get_avatar( $the_query->post_author, $size = '45', $default = '', $alt= '', array( 'class' => array( 'img-responsive' ) )).' <span class="nth-style-0">'.get_the_author_meta('user_nicename', $author_id).'</span> 
														</div>
